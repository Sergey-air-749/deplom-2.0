...
export default function sendFileStory() {
    ...
    const deleteAllFilesStory = async () => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:7000/api/story/send/deleteAll/', {}, {
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`,
                }
    ...
    const deleteFileStory = async (id: string) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:7000/api/story/send/delete/' + id, {}, {
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`,
                }
                    ...
                    <div className={style.formHead}>
                        ...
                        <div className={style.navigationPage}>
                            ...
                            <div className={style.navStoryOptionsBlock}>
                                <div className={style.navStoryOptions}>
                                    <Link className={`${style.LinkStoryOptions}`} href={'/story/get'}>Принятые</Link>
                                    <Link className={`${style.LinkStoryOptions} ${style.select}`} href={'/story/send'}>Отправленные</Link>
                                </div>
                            </div>
                        ...
                        <div className={style.formIcon}>
                            ...
                            <svg width="80" height="80" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M53 15C54.1046 15 55 15.8954 55 17V53C55 54.1046 54.1046 55 53 55H17C15.8954 55 15 54.1046 15 53V30L30 15H53ZM24.9189 33.3193C24.19 32.5908 23.0082 32.5906 22.2793 33.3193L17.6592 37.9395C17.2948 38.3039 17.2948 38.8953 17.6592 39.2598C18.0236 39.6242 18.615 39.6241 18.9795 39.2598L22.666 35.5723V52.0664C22.666 52.5818 23.0842 52.9999 23.5996 53C24.1151 53 24.5332 52.5819 24.5332 52.0664V35.5732L28.2197 39.2598C28.5842 39.6239 29.1747 39.624 29.5391 39.2598C29.9036 38.8953 29.9036 38.304 29.5391 37.9395L24.9189 33.3193ZM42 31C35.9249 31 31 35.9249 31 42C31 48.0751 35.9249 53 42 53C48.0751 53 53 48.0751 53 42C53 35.9249 48.0751 31 42 31ZM42 33C46.9706 33 51 37.0294 51 42C51 46.9706 46.9706 51 42 51C37.0294 51 33 46.9706 33 42C33 37.0294 37.0294 33 42 33ZM42 34.1426C41.5661 34.1426 41.2139 34.4948 41.2139 34.9287V41.6436L37.8867 44.4355C37.5547 44.7144 37.5115 45.2097 37.79 45.542C38.069 45.8744 38.565 45.9176 38.8975 45.6387L42.5088 42.6084C42.7163 42.4341 42.8113 42.1755 42.7852 41.9248V34.9287C42.7852 34.4948 42.4339 34.1427 42 34.1426Z" fill="#008CFF"/>
                        ...
                        <div className={style.formTitle}>
                            ...
                            <p>Здесь вы можете посмотреть все файлы которые отправели, время, от кого и скакого устройства</p>
                        </div>
